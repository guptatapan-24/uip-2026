...
from nvd_client import get_nvd_client, CVERecord
...
class Retriever:
    ...
    async def retrieve_for_attack_technique(self, technique_id: str) -> List[RetrievalResult]:
        """
    ...
    async def retrieve_all(
        ...
        for claim in claims:
            ...
            if claim_type == "CVE_ID":
                ...
                results[claim_value] = await self.retrieve_for_attack_technique(claim_value)
